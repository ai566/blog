import{_ as s,o as a,c as n,Q as l}from"./chunks/framework.9bc09dc8.js";const _=JSON.parse('{"title":"对象方法的简写","description":"","frontmatter":{},"headers":[],"relativePath":"JavaScript/对象方法的简写.md","filePath":"JavaScript/对象方法的简写.md"}'),p={name:"JavaScript/对象方法的简写.md"},o=l(`<h1 id="对象方法的简写" tabindex="-1">对象方法的简写 <a class="header-anchor" href="#对象方法的简写" aria-label="Permalink to &quot;对象方法的简写&quot;">​</a></h1><p>对象往往具备多个方法，方法其实就是函数，只不过在对象的命名空间中我们称之为方法，例如：</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">const</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">obj</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">=</span><span style="color:#E1E4E8;"> {</span></span>
